...
- The Pikeman is the Metal–Food idea in one card: 2 power, and +1 for every round it has held its lane. Fed and armed, it is worth nothing the turn it lands and unanswerable if ignored, so it asks the rival to spend something on a lane they would rather have walked past.
