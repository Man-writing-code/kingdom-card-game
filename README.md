...
- **Fortification** is stone raised in front of the keep. It takes damage before health does, and unlike health it is not capped at 10 — a Gatehouse raises 2 when revealed, so a walled ruler can stand at an effective 12 or more. A Palisade still blunts a strike before the fortification is asked to hold it.
...
- The 41-design global pool supports six identities: Food swarms, realm-wide Granary support, and Boar Rider finishers; Wood Palisade defence; pure-Metal elites; Food–Wood hunting engines; Metal–Wood Ballista and Pavise fortifications; and Metal–Food ground that is held rather than taken. The Foreign Mercenary offers any realm a 3-power unit for 1 gold, then leaves after its second clash. (The Charge mechanic that once occupied Metal–Food is shelved; old saves shed those cards automatically.)
...
- The Granary costs 5 food and gives +1 power to every friendly unit whose printed cost includes food, wherever it stands. Multiple Granaries stack.
